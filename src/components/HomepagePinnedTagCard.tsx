...
import './homepagePinnedTagCard.css';

interface HomepagePinnedTagCardProps {
  tag: Tag;
...
export const HomepagePinnedTagCard = ({
  tag,
  onClick,
  onDoubleClick,
  onTogglePin,
}: HomepagePinnedTagCardProps) => {
  ...
  return (
    <div
      className="homepage-pinned-tag-card"
      onClick={handleCardClick}
      onDoubleClick={handleCardDoubleClick}
    >
      <div className="homepage-pinned-tag-card__header">
      ...
      {tag.description && (
        <div className="homepage-pinned-tag-card__description">{tag.description}</div>
      )}

      <div className="homepage-pinned-tag-card__stats">
        <div className="homepage-pinned-tag-card__stat-item">
