...
export const WorkstationCard = ({ workstation, onEdit, onTogglePin, onClick }: WorkstationCardProps) => {
  ...
  return (
    <div 
      className={`workstation-card ${workstation.pinned ? 'workstation-card--pinned' : ''}`}
    ...
    >
      ...
      <div className="workstation-card__footer">
        {workstation.description && (
          <div className="workstation-card__description">{workstation.description}</div>
        )}
        <div className="workstation-card__stats">
          <div className="workstation-card__stat-item">
            ...
            <span>{workstation.bookmarks.length || 0}</span>
          </div>
          <div className="workstation-card__stat-item">
            <svg width="14" height="14" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
            ...
            <span>{workstation.clickCount || 0}</span>
          </div>
        </div>
      </div>
    </div>
